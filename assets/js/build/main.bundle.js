...
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"], gsap_CustomEase__WEBPACK_IMPORTED_MODULE_3__.CustomEase);
 //init smooth scroll
...
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"]); // scroll.on("scroll", ScrollTrigger.update);

gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].config({
  autoRefreshEvents: "visibilitychange,DOMContentLoaded,load"
});
var lenis = new _studio_freight_lenis__WEBPACK_IMPORTED_MODULE_4__["default"]();
var scroll = lenis; // lenis.on('scroll', (e) => {
//     console.log(e)
// })

lenis.on('scroll', gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].update);
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].ticker.add(function (time) {
  lenis.raf(time * 1000);
});
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].ticker.lagSmoothing(0); //dynamically adjust height of education timeline

function SetLineHeight() {
  var tl_line = document.querySelector(".tl-line");
  var abi_dim = document.querySelector("#tl-header-flex-abi").getBoundingClientRect();
  var master_dim = document.querySelector("#tl-header-flex-master").getBoundingClientRect();
  var tl_line_height = master_dim.top - abi_dim.top + master_dim.height / 2 - abi_dim.height / 2;
  tl_line.style.top = "".concat(abi_dim.height / 2, "px");
  tl_line.style.height = "".concat(tl_line_height, "px");
}
...
window.addEventListener("load", function () {
  SetLineHeight(); // scroll.update();

  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].refresh();
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].update();
});

window.onresize = function () {
  SetLineHeight();
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].refresh();
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"].update(); // scroll.update();
}; //nav click events
//ids: nav-contact; nav-bio


var nav_bio = document.querySelector("#nav-bio");
var nav_contact = document.querySelector("#nav-contact");
nav_bio.addEventListener("click", function (event) {
  event.preventDefault();
...
var split = function split(toSplit) {
  var els = document.querySelectorAll(toSplit);
  Array.prototype.forEach.call(els, function (el) {
    el.innerHTML = el.innerHTML.replace(/(^|<\/?[^>]+>|\s+)([^\s<]+)/g, '$1<span class="rev" style="opacity: 0">$2</span>');
  });
  var el_spans = document.querySelectorAll("".concat(toSplit, " span"));
...
split(".abstract-text");
split(".tl-header");
split(".pt-header .exp-point-header"); // split(".pt-header-subheader .gen-subheader");

split(".project-header");
split(".project-info .gen-detail");
split("#section-contact .quote-text"); //load animation*********************************************************************

var tl_hero = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline();
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set("#section-edu", {
  visibility: "visible"
});
tl_hero.add(gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo(".journal-desc.nav", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
  yPercent: 0,
  duration: 1
}).delay(0.3)).fromTo(".nav-first > .nav-a-replace > .nav-title-wrapper > .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
  yPercent: 0,
  duration: 0.6
}, "<+=0.1").fromTo(".nav-second > .nav-a-replace > .nav-title-wrapper > .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
  yPercent: 0,
  duration: 0.6
}, "<+=0.2").fromTo("#hero-header", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.001
}, "<").fromTo("#hero-header .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
  ...
  opacity: 0.8,
  duration: 4
}, "<+=0.1").fromTo(".author.rev", {
  opacity: 0
}, {
  opacity: 1,
  duration: 2
}, "<+=0.8").fromTo("#section-hero  .page-break", {
  scaleX: 0,
  opacity: 0
}, {
  scaleX: 1,
  ...
  opacity: 1,
  duration: 2
}, "<+=0.25").fromTo("#abstract-text-id", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.001
}, "<").fromTo("#abstract-text-id .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
var tl_edu_desc = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_edu_desc.fromTo("#section-edu .wtm-category", {
  opacity: 0.01
}, {
  opacity: 1,
  duration: 2.5
}).fromTo("#section-edu .page-break", {
  scaleX: 0,
  opacity: 0
}, {
  scaleX: 1,
  ...
  ease: "power2.out"
}, "<").fromTo("#section-edu .desc-number", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
}, "<").fromTo("#section-edu .desc-review", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
...
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo(".tl-line", {
  scaleY: 0
}, {
  scrollTrigger: {
    // scroller: scrollContainer,
...
var tl_edu_first = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
    trigger: "#edu-tl-container .tl-point:nth-child(2)",
    // scroller: scrollContainer,
...
tl_edu_first.fromTo(".tl-point:nth-child(2) .tl-marker-container", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.8
}).fromTo(".tl-point:nth-child(2) .rev", {
  yPercent: 100,
  opacity: 0
}, {
  yPercent: 0,
...
}, "<").fromTo(".tl-point:nth-child(2) .gen-detail", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1,
...
}, "<+=0.8"); //education section second point***********

var tl_edu_second = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_edu_second.fromTo(".tl-point:nth-child(2) .tl-footer-container", {
  ...
  opacity: 1,
  duration: 2.4
}).fromTo(".tl-point:nth-child(3) .tl-marker-container", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.8
}, "<").fromTo(".tl-point:nth-child(3) .rev", {
  yPercent: 100,
  opacity: 0
}, {
  yPercent: 0,
...
}, "<").fromTo(".tl-point:nth-child(3) .gen-detail", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1,
...
}, "<+=0.8"); //education section third point***********

var tl_edu_third = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_edu_third.fromTo(".tl-point:nth-child(3) .tl-footer-container", {
  clipPath: "polygon(0 0, 0 0, 0 100%, 0% 100%)",
  opacity: 0
}, {
  clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)",
  ...
  duration: 1.6,
  ease: "power1.out"
}).fromTo(".tl-point:nth-child(4) .tl-marker-container", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.8
}, "<").fromTo(".tl-point:nth-child(4) .rev", {
  yPercent: 100,
  opacity: 0
}, {
  yPercent: 0,
...
}, "<").fromTo(".tl-point:nth-child(4) .gen-detail", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.5,
...
}, "<+=0.8"); //Animation experiece section***********************************************************
// let exp_bg_delay = 0.5;
// let right_side_delay = 0.5;

var tl_exp_desc = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_exp_desc.fromTo("#section-exp .page-break", {
  scaleX: 0,
  opacity: 0
}, {
  scaleX: 1,
  ...
  // ease: "Power1.easeInOut",
  ease: "power2.out"
}).fromTo("#section-exp .desc-number", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
}, "<").fromTo("#section-exp .desc-review", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
}, "<+=0.1").fromTo("#exp-middle-seperator", {
  scaleY: 0,
  opacity: 0
}, {
  opacity: 1,
...
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo("#section-exp .wtm-category", {
  opacity: 0.01
}, {
  scrollTrigger: {
    trigger: "#section-exp .wtm-category",
...
var tl_exp_first_intro = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_exp_first_intro.fromTo(".first-tbl .tbl-intro-bg", {
  scaleX: 0,
  opacity: 0
}, {
  scaleX: 1,
  opacity: 1,
  duration: 1.5
}, "<").fromTo(".first-tbl .tbl-intro.rev", {
  yPercent: 100
}, {
  yPercent: 0,
  duration: 1
}, "<");
var tl_exp_first_header = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_exp_first_header.fromTo(".first-tbl .pt-header  .exp-point-header .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
}, "<").fromTo(".first-tbl .pt-header  .pt-header-border-left", {
  scaleY: 0,
  opacity: 0
}, {
  scaleY: 1,
  ...
  duration: 1,
  delay: 0.1
}, "<").fromTo(".first-tbl .pt-header-subheader .gen-subheader", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
}, "<+=0.3").fromTo(".first-tbl .pt-header .right-half .tbl-misc", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.8,
...
var tl_exp_first_detail = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_exp_first_detail.fromTo(".first-tbl .pt-detail", {
  opacity: 0,
  x: -10
}, {
  opacity: 1,
...
}, "<").fromTo(".first-tbl .tbl-pt-detail-sep", {
  clipPath: "polygon(0 0, 0 0, 0 100%, 0% 100%)",
  opacity: 0
}, {
  clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)",
...
var tl_exp_second_intro = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_exp_second_intro.fromTo(".second-tbl .tbl-intro-bg", {
  scaleX: 0,
  opacity: 0
}, {
  scaleX: 1,
  opacity: 1,
  duration: 1.5
}, "<").fromTo(".second-tbl .tbl-intro.rev", {
  yPercent: 100
}, {
  yPercent: 0,
  duration: 1
}, "<");
var tl_exp_second_header = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_exp_second_header.fromTo(".second-tbl .pt-header  .exp-point-header .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
}, "<").fromTo(".second-tbl .pt-header  .pt-header-border-left", {
  scaleY: 0,
  opacity: 0
}, {
  scaleY: 1,
  ...
  duration: 1,
  delay: 0.1
}, "<").fromTo(".second-tbl .pt-header-subheader .gen-subheader", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
}, "<+=0.3").fromTo(".second-tbl .pt-header .right-half .tbl-misc", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.8,
...
var tl_exp_second_detail = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_exp_second_detail.fromTo(".second-tbl .pt-detail", {
  opacity: 0,
  x: -10
}, {
  opacity: 1,
...
}, "<").fromTo(".second-tbl .tbl-pt-detail-sep", {
  clipPath: "polygon(0 0, 0 0, 0 100%, 0% 100%)",
  opacity: 0
}, {
  clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)",
...
var tl_pro_desc = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_pro_desc.fromTo("#section-pro .page-break", {
  scaleX: 0,
  opacity: 0
}, {
  scaleX: 1,
  ...
  // ease: "Power1.easeInOut",
  ease: "power2.out"
}).fromTo("#section-pro .desc-number", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
}, "<").fromTo("#section-pro .desc-review", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
...
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo(".projects-grid-wrapper .grid-row:nth-child(1)", {
  xPercent: 0
}, {
  scrollTrigger: {
    trigger: "#section-pro .projects-grid-wrapper",
...
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo(".projects-grid-wrapper .grid-row:nth-child(2)", {
  xPercent: 0
}, {
  scrollTrigger: {
    trigger: "#section-pro .projects-grid-wrapper",
...
gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo(".projects-grid-wrapper .grid-row:nth-child(3)", {
  xPercent: 0
}, {
  scrollTrigger: {
    trigger: "#section-pro .projects-grid-wrapper",
...
var tl_pro_first = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_pro_first.fromTo("#esports-wrapper .project-header .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
}, "<").fromTo("#esports-wrapper .gen-detail .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
}, "<+=0.3").fromTo("#esports-wrapper .project-info-code", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.5
}, "<+=0.5").fromTo("#esports-wrapper .project-info-links", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.5
}, "<+=0.2"); //first project animation - images*******************

var tl_pro_first_img = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
    trigger: "#esports-wrapper",
    // scroller: scrollContainer,
    start: "top bottom",
...
tl_pro_first_img.fromTo("#esports-wrapper .img-row-wrapper .vignette", {
  y: -15
}, {
  y: -50
}, "<").fromTo("#esports-wrapper .img-row-wrapper .img-row:nth-child(2) .img-wrapper:nth-child(1)", {
  y: 0
}, {
  y: -50
}, "<").fromTo("#esports-wrapper .img-row-wrapper .img-row:nth-child(2) .img-wrapper:nth-child(2)", {
  y: 0
}, {
  y: -50
}, "<").fromTo("#esports-wrapper .img-row-wrapper .img-row:nth-child(1) .img-wrapper:nth-child(2)", {
  y: 0
}, {
  y: -40
}, "<").fromTo("#esports-wrapper .img-row-wrapper .img-row:nth-child(1) .img-wrapper:nth-child(1)", {
  y: 0
}, {
  y: -40
}, "<"); //second project animation*******************

var tl_pro_second = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_pro_second.fromTo("#bejour-wrapper .project-header .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
}, "<").fromTo("#bejour-wrapper .gen-detail .rev", {
  opacity: 0,
  yPercent: 100
}, {
  opacity: 1,
...
}, "<+=0.3").fromTo("#bejour-wrapper .project-info-code", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.5
}, "<+=0.5").fromTo("#bejour-wrapper .project-info-links", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.5
}, "<+=0.2"); //second project animation - images*******************

var tl_pro_second_img = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
    trigger: "#bejour-wrapper",
    // scroller: scrollContainer,
    start: "top bottom",
...
tl_pro_second_img.fromTo("#bejour-wrapper .img-row-wrapper .vignette", {
  y: -15
}, {
  y: -50
}, "<").fromTo("#bejour-wrapper .img-row-wrapper .img-row:nth-child(2) .img-wrapper:nth-child(1)", {
  y: 0
}, {
  y: -50
}, "<").fromTo("#bejour-wrapper .img-row-wrapper .img-row:nth-child(2) .img-wrapper:nth-child(2)", {
  y: 0
}, {
  y: -50
}, "<").fromTo("#bejour-wrapper .img-row-wrapper .img-row:nth-child(1) .img-wrapper:nth-child(2)", {
  y: 0
}, {
  y: -40
}, "<").fromTo("#bejour-wrapper .img-row-wrapper .img-row:nth-child(1) .img-wrapper:nth-child(1)", {
  y: 0
}, {
  y: -40
}, "<"); //Animation contact section***********************************************************

var tl_contact_desc = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_contact_desc.fromTo("#section-contact .page-break", {
  scaleX: 0,
  opacity: 0
}, {
  scaleX: 1,
  ...
  // ease: "Power1.easeInOut",
  ease: "power2.out"
}).fromTo("#section-contact .desc-number", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
}, "<").fromTo("#section-contact .desc-review", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
}, "<+=0.1");
var tl_contact = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
  scrollTrigger: {
...
tl_contact.fromTo("#section-contact #quote-icon", {
  opacity: 0
}, {
  opacity: 1,
  duration: 0.8
}, "<").fromTo("#section-contact .contact-text-wrapper .rev", {
  yPercent: 100,
  opacity: 0
}, {
  yPercent: 0,
...
}, "<").fromTo("#section-contact .contact-info-wrapper .gen-detail", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
}, "<+=1").fromTo("#section-contact .contact-info-wrapper #contact-icons", {
  opacity: 0
}, {
  opacity: 1,
  duration: 1
}, "<+=0.2"); //Education Section

var prevScrollEdu = 0;
var scrollDirectionEdu = 1;
var EduPosition = document.querySelector(".wtm-marquee.wtm-edu").getBoundingClientRect().top;
var loopsEdu;
var initEdu = 0;
lenis.on("scroll", function () {
  ...
  if (nextScroll + window.innerHeight >= EduPosition) {
    if (initEdu == 0) {
      loopsEdu = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].utils.toArray(".wtm-single.wtm-edu").map(function (line, i) {
        var links = line.querySelectorAll(".wtm-edu.js-text");
        var speed = window.innerWidth > 800 ? 1 + i * 0.5 : 0.5 + i * 0.5;
        initEdu = 1;
        return horizontalLoop(links, {
          repeat: -1,
          speed: speed,
          reversed: false,
          paddingRight: parseFloat(gsap__WEBPACK_IMPORTED_MODULE_1__["default"].getProperty(links[0], "marginRight", "px"))
        });
      });
    }
    ...
    if (direction !== scrollDirectionEdu && nextScroll + window.innerHeight >= EduPosition) {
      try {
        loopsEdu.forEach(function (tl) {
          return gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to(tl, {
            timeScale: direction,
            overwrite: true
          });
        });
...
var prevScrollExp = 0;
var scrollDirectionExp = 1;
var ExpPosition = document.querySelector(".wtm-marquee.wtm-exp").getBoundingClientRect().top;
var loopsExp;
var initExp = 0;
scroll.on("scroll", function () {
  ...
  if (nextScroll + window.innerHeight >= ExpPosition) {
    if (initExp == 0) {
      loopsExp = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].utils.toArray(".wtm-single.wtm-exp").map(function (line, i) {
        var links = line.querySelectorAll(".wtm-exp.js-text");
        var speed = window.innerWidth > 800 ? 1 + i * 0.5 : 0.5 + i * 0.5;
        initExp = 1;
        return horizontalLoop(links, {
          repeat: -1,
...
function horizontalLoop(items, config) {
  items = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].utils.toArray(items);
  config = config || {};
  var tl = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
    ...
    return v;
  } : gsap__WEBPACK_IMPORTED_MODULE_1__["default"].utils.snap(config.snap || 1),
      totalWidth,
      curX,
      distanceToStart,
      distanceToLoop,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(items, {
    xPercent: function xPercent(i, el) {
      var w = widths[i] = parseFloat(gsap__WEBPACK_IMPORTED_MODULE_1__["default"].getProperty(el, "width", "px"));
      xPercents[i] = snap(parseFloat(gsap__WEBPACK_IMPORTED_MODULE_1__["default"].getProperty(el, "x", "px")) / w * 100 + gsap__WEBPACK_IMPORTED_MODULE_1__["default"].getProperty(el, "xPercent"));
      return xPercents[i];
    }
  });
  gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(items, {
  ...
  totalWidth = items[length - 1].offsetLeft + xPercents[length - 1] / 100 * widths[length - 1] - startX + items[length - 1].offsetWidth * gsap__WEBPACK_IMPORTED_MODULE_1__["default"].getProperty(items[length - 1], "scaleX") + (parseFloat(config.paddingRight) || 0);

  for (i = 0; i < length; i++) {
    item = items[i];
    curX = xPercents[i] / 100 * widths[i];
    distanceToStart = item.offsetLeft + curX - startX;
    distanceToLoop = distanceToStart + widths[i] * gsap__WEBPACK_IMPORTED_MODULE_1__["default"].getProperty(item, "scaleX");
    tl.to(item, {
  ...
  function toIndex(index, vars) {
    ...
    var newIndex = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].utils.wrap(0, length, index),
        time = times[newIndex];

    if (time > tl.time() !== index > curIndex) {
      vars.modifiers = {
        time: gsap__WEBPACK_IMPORTED_MODULE_1__["default"].utils.wrap(0, tl.duration())
      };
